namespace LetsMusic.Presentation.Presentations
{
    public static class Messages
    {
        ...
        public const string CourseIdInput = "Digite o código";
        ...
        public const string yearInput = "Digite o ano";
        public const string yearInputError = "Digite um número inteiro. Não é aceito campo vazio e negativo";
        public const string workLoadInput = "Digite a carga horário do curso";
        public const string workLoadInputError = "Digite um número inteiro. Não é aceito campo vazio e negativo";
        public const string vacanciesInput = "Digite as vagas disponíveis para o curso";
        public const string vacanciesInputError = "Digite um número inteiro.Não é aceito campo vazio e negativo";
